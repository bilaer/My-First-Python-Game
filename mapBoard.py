map = [[0] * 45 for i in range(45)]
# The row and col of the map
rowOfMap = len(map)
colOfMap = len(map[0])
# Two entrance of the map that can be passed

entranceColOne = (33, 40)
entranceRowOne = (15, 18)
entranceRowTwo = (3, 6)
entranceColTwo = (31, 32)
